...
def create_patient_identifiers_for_existing_abha(apps, schema_editor):
    ...
    patient_identifier_config, _ = PatientIdentifierConfig.objects.get_or_create(
        config__system=plugin_settings.ABHA_NUMBER_CODE_SYSTEM.get("system"),
        defaults={
            "status": "active",
            "config": {
                "use": "official",
                "description": plugin_settings.ABHA_NUMBER_CODE_SYSTEM.get("display"),
                "required": False,
                "unique": True,
                "regex": "",
                "system": plugin_settings.ABHA_NUMBER_CODE_SYSTEM.get("system"),
                "display": plugin_settings.ABHA_NUMBER_CODE_SYSTEM.get("display"),
                "retrieve_config": {
